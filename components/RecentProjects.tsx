            ...
            {projects.map(({
                ...
                <div key={id} className="lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw] sm:h-[41rem] h-[32rem]">
                    <PinContainer title={link} href="#projects">
                        ...
                        <h1 className="flex items-center justify-center font-bold lg:text-2xl md:text-xl text-base line-clamp-1">
                            {title}
                        </h1>
                        ...
                        <div className="flex items-center justify-between mt-7 mb-3">
                            <div className="flex items-center">
                                {iconLists.map((icon, index) => (
                                    <div key={icon} className="border border-white/[0.2] rounded-full bg-black lg:w-10lg:h-10 w-8 h-8 flex justify-center items-center" style={{
